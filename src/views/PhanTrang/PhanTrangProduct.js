...
class PhanTrangProduct extends Component {
  ...
  async componentDidMount() {
    ...
    let response = await axios.get(
      "http://localhost:8081/api/v1/testthu-product"
    );
          ...
          <ul className="pagination phantrang">
            <li className="page-item">
              <a
                ...
                href="#"
                onClick={() =>
                  this.props.handleListProduct(this.props.pageHienTai - 1)
                }
              >
                {" "}
                <FaChevronLeft />
                ...
                .map((item, index) => {
                  return (
                    <li className="page-item">
                      ...
                      <a
                        className="page-link"
                        onClick={() => this.props.handleListProduct(index + 1)}
                        href="#"
                      >
                        {index + 1}
                      </a>
